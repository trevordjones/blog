...
That's all for now! If you want to keep chugging forward, we can do [Github]({% post_url 2014-06-23-blog/github %}) next! Ask any questions below if something didn't make sense or if you got stuck. I'm glad to help!